...
class ModelEvaluation:
    """
    A class to evaluate the trained model against a previously saved model.
    ...
    data_ingestion_artifact : artifact_entity.DataIngestionArtifact
        The artifact from data ingestion.
    data_transformation_artifact : artifact_entity.DataTransformationArtifact
        The artifact from data transformation.
    model_trainer_artifact : artifact_entity.ModelTrainerArtifact
        The artifact from model training.
    model_resolver : ModelResolver
        The resolver for managing model paths.

    Methods:
    -------
    initiate_model_evaluation() -> artifact_entity.ModelEvaluationArtifact
        Evaluates the current model against the previous model and returns the evaluation artifact.
    """
    ...
    def initiate_model_evaluation(self) -> artifact_entity.ModelEvaluationArtifact:
        ...
        artifact_entity.ModelEvaluationArtifact
            The artifact containing the evaluation result.
        """
        try:
            ...
            # Previous trained objects loaded from theire location path
